...
NWC_SWITCH = "switched"                     # switch number, on or off
NWC_SWITCH_REQUEST = "switch request"       # Request the actual position of the switch, pin number
NWC_SOIL_LOAD = "soil_load"                 # Reload soil sensors
NWC_WORKSHOP_HEATER = "workshop_heater"     # Reload workshop heater settings
NWC_WH_DURATION = "water heater duration"   #
