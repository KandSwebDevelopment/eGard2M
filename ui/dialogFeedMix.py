...
class Ui_DialogFeedMix(object):
    def setupUi(self, DialogFeedMix):
        ...
        self.gb_nutrients = QtWidgets.QGroupBox(self.fr_feed)
        self.gb_nutrients.setGeometry(QtCore.QRect(20, 160, 391, 61))
        self.gb_nutrients.setObjectName("gb_nutrients")
        self.pb_reset_nutrients = QtWidgets.QPushButton(self.gb_nutrients)
        self.pb_reset_nutrients.setGeometry(QtCore.QRect(340, 30, 31, 23))
        self.pb_reset_nutrients.setObjectName("pb_reset_nutrients")
        self.le_ml_1 = QtWidgets.QLineEdit(self.gb_nutrients)
        self.le_ml_1.setGeometry(QtCore.QRect(140, 30, 51, 20))
        self.le_ml_1.setInputMask("")
        self.le_ml_1.setObjectName("le_ml_1")
        self.label_24 = QtWidgets.QLabel(self.gb_nutrients)
        self.label_24.setGeometry(QtCore.QRect(190, 30, 30, 20))
        self.label_24.setMinimumSize(QtCore.QSize(30, 20))
        self.label_24.setAlignment(QtCore.Qt.AlignCenter)
        self.label_24.setObjectName("label_24")
        self.pb_store_n_1 = QtWidgets.QPushButton(self.gb_nutrients)
        self.pb_store_n_1.setGeometry(QtCore.QRect(250, 27, 70, 27))
        ...
        self.cb_nutrients_1 = QtWidgets.QComboBox(self.gb_nutrients)
        self.cb_nutrients_1.setGeometry(QtCore.QRect(10, 31, 100, 20))
        ...
        self.cb_mute.setGeometry(QtCore.QRect(100, 500, 111, 22))
    ...
    def retranslateUi(self, DialogFeedMix):
        ...
        self.gb_water.setTitle(_translate("DialogFeedMix", "Water"))
        ...
        self.gb_items.setTitle(_translate("DialogFeedMix", "Items"))
        ...
        self.gb_nutrients.setTitle(_translate("DialogFeedMix", "Nutrients"))
