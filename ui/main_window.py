...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuReboot_2 = QtWidgets.QMenu(self.menuEngineer)
        self.menuReboot_2.setObjectName("menuReboot_2")
        self.menuSensors = QtWidgets.QMenu(self.menuSystem)
        ...
        self.actionDTH_s = QtWidgets.QAction(MainWindow)
        self.actionDTH_s.setObjectName("actionDTH_s")
        self.actionFeeder_Unit = QtWidgets.QAction(MainWindow)
        self.actionFeeder_Unit.setObjectName("actionFeeder_Unit")
        self.actionIO_Unit = QtWidgets.QAction(MainWindow)
        self.actionIO_Unit.setObjectName("actionIO_Unit")
        self.actionDE_Module = QtWidgets.QAction(MainWindow)
        self.actionDE_Module.setObjectName("actionDE_Module")
        self.actionTemperature = QtWidgets.QAction(MainWindow)
        self.actionTemperature.setObjectName("actionTemperature")
        self.actionTamperature_Humidity = QtWidgets.QAction(MainWindow)
        self.actionTamperature_Humidity.setObjectName("actionTamperature_Humidity")
        self.menuReboot_2.addAction(self.actionDTH_s)
        self.menuReboot_2.addAction(self.actionFeeder_Unit)
        self.menuReboot_2.addAction(self.actionIO_Unit)
        self.menuReboot_2.addAction(self.actionDE_Module)
        ...
        self.menuEngineer.addAction(self.menuReboot_2.menuAction())
        self.menuEngineer.addAction(self.actionI_O_VC)
        self.menuSensors.addAction(self.actionTemperature)
        self.menuSensors.addAction(self.actionTamperature_Humidity)
        self.menuSystem.addAction(self.actionSettings)
        self.menuSystem.addAction(self.menuEngineer.menuAction())
        self.menuSystem.addAction(self.menuSensors.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuReboot_2.setTitle(_translate("MainWindow", "Reboot"))
        ...
        self.actionDTH_s.setText(_translate("MainWindow", "DTH\'s"))
        self.actionFeeder_Unit.setText(_translate("MainWindow", "Feeder Unit"))
        self.actionIO_Unit.setText(_translate("MainWindow", "IO Unit"))
        self.actionDE_Module.setText(_translate("MainWindow", "DE Module"))
        self.actionTemperature.setText(_translate("MainWindow", "Temperature"))
        self.actionTamperature_Humidity.setText(_translate("MainWindow", "Temperature + Humidity"))
