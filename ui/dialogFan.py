...
class Ui_DialogFan(object):
    def setupUi(self, DialogFan):
        ...
        self.frame.setGeometry(QtCore.QRect(6, 86, 131, 121))
        ...
        self.pb_close.setGeometry(QtCore.QRect(70, 296, 75, 23))
        self.pb_close.setObjectName("pb_close")
        self.pb_master = QtWidgets.QPushButton(DialogFan)
        self.pb_master.setGeometry(QtCore.QRect(60, 226, 51, 23))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 230, 47, 13))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(DialogFan)
        self.label_4.setGeometry(QtCore.QRect(10, 260, 47, 13))
        self.label_4.setObjectName("label_4")
        self.cb_sensor = QtWidgets.QComboBox(DialogFan)
        self.cb_sensor.setGeometry(QtCore.QRect(60, 256, 91, 22))
        self.cb_sensor.setObjectName("cb_sensor")
        self.cb_mode = QtWidgets.QComboBox(DialogFan)
        self.cb_mode.setGeometry(QtCore.QRect(10, 61, 131, 21))
        ...
        self.line.setGeometry(QtCore.QRect(10, 206, 151, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.lbl_master = QtWidgets.QLabel(DialogFan)
        self.lbl_master.setGeometry(QtCore.QRect(120, 226, 31, 22))
