...
class Ui_DialogSoilSensors(object):
    def setupUi(self, DialogSoilSensors):
        ...
        self.pb_advanced.setGeometry(QtCore.QRect(140, 140, 75, 23))
        ...
        self.pb_read.setGeometry(QtCore.QRect(140, 80, 75, 23))
    ...
    def retranslateUi(self, DialogSoilSensors):
        ...
        self.pb_advanced.setText(_translate("DialogSoilSensors", "Limits"))
